...
class TraceScope {
  private:
    ...
    int line;
  public:
    static bool sSerialIsAvailable;
...
#ifndef HEADLESS
#define P(args) if (TraceScope::sSerialIsAvailable) {Serial.print(args);}
#define PL(args) if (TraceScope::sSerialIsAvailable) {Serial.println(args);}
...
#define PH5(arg1,arg2,arg3,arg4,arg5) _PWHERE(tscope.getFunc(),__FILE__,__LINE__); P(arg1); P(arg2); P(arg3); P(arg4); PL(arg5);
#define PH6(arg1,arg2,arg3,arg4,arg5,arg6) _PWHERE(tscope.getFunc(),__FILE__,__LINE__); P(arg1); P(arg2); P(arg3); P(arg4); P(arg5); PL(arg6);
#else
#ifndef NDEBUG
#   define NDEBUG
#endif
...
#define PH5(arg1,arg2,arg3,arg4,arg5) do {} while (0)
#define PH6(arg1,arg2,arg3,arg4,arg5,arg6) do {} while (0)
#endif
...
#  define _TWHERE_FILE5(TAG,FILE,LINE,MSG1,MSG2,MSG3,MSG4,MSG5) _TAG(TAG); _TAG(FILE); _L(LINE); D(MSG1); D(MSG2); D(MSG3); D(MSG4); DL(MSG5);
#  define _TWHERE_FILE6(TAG,FILE,LINE,MSG1,MSG2,MSG3,MSG4,MSG5,MSG6) _TAG(TAG); _TAG(FILE); _L(LINE); D(MSG1); D(MSG2); D(MSG3); D(MSG4); D(MSG5); DL(MSG6);
...
#  define _TWHERE_FUNC5(TAG,FUNC,LINE,MSG1,MSG2,MSG3,MSG4,MSG5) _TAG(TAG); _TAG(FUNC); _L(LINE); D(MSG1); D(MSG2); D(MSG3); D(MSG4); DL(MSG5);
#  define _TWHERE_FUNC6(TAG,FUNC,LINE,MSG1,MSG2,MSG3,MSG4,MSG5,MSG6) _TAG(TAG); _TAG(FUNC); _L(LINE); D(MSG1); D(MSG2); D(MSG3); D(MSG4); D(MSG5); DL(MSG6);
...
#  define _TWHERE5(TAG,FUNC,FILE,LINE,MSG1,MSG2,MSG3,MSG4,MSG5) if(FUNC==0){_TWHERE_FILE5(TAG,FILE,LINE,MSG1,MSG2,MSG3,MSG4,MSG5)}else{_TWHERE_FUNC5(TAG,FUNC,LINE,MSG1,MSG2,MSG3,MSG4,MSG5)}
#  define _TWHERE6(TAG,FUNC,FILE,LINE,MSG1,MSG2,MSG3,MSG4,MSG5,MSG6) if(FUNC==0){_TWHERE_FILE6(TAG,FILE,LINE,MSG1,MSG2,MSG3,MSG4,MSG5,MSG6)}else{_TWHERE_FUNC6(TAG,FUNC,LINE,MSG1,MSG2,MSG3,MSG4,MSG5,MSG6)}
...
#   define TRACE5(msg1,msg2,msg3,msg4,msg5) _TWHERE5("TRACE",tscope.getFunc(),__FILE__,__LINE__,msg1,msg2,msg3,msg4,msg5);
#   define TRACE6(msg1,msg2,msg3,msg4,msg5,msg6) _TWHERE6("TRACE",tscope.getFunc(),__FILE__,__LINE__,msg1,msg2,msg3,msg4,msg5,msg6);
...
#   define TRACE5(msg1,msg2,msg3,msg4,msg5) while (0);
#   define TRACE6(msg1,msg2,msg3,msg4,msg5,msg6) while (0);
